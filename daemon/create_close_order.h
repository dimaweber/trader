...
bool create_order (Database& database, quint32 round_id, const QString& pair, BtcObjects::Order::OrderType type, double rate, double amount, BtcObjects::Funds& funds, bool silent_http, bool silent_sql);
